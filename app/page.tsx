    ...
    <main className="min-h-screen bg-[#071120] text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#071120]/60 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-5 lg:px-20">
          <Link href="#" className="text-2xl font-semibold tracking-[0.14em] text-white drop-shadow-[0_0_16px_rgba(37,99,235,0.6)]">FINVERZE</Link>
      ...
      <section className="mx-auto grid min-h-screen w-full max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-[100px] lg:grid-cols-12 lg:px-20">
        <div className="lg:col-span-6">
          <h1 className="text-5xl font-bold leading-[1.1] tracking-tight md:text-6xl font-serif">Building Strong Financial Habits for the Next Generation.</h1>
      ...
      <section id="contact" className="mx-auto grid max-w-[1200px] grid-cols-1 gap-8 px-6 pb-[100px] lg:grid-cols-12 lg:px-20">
        <div className="lg:col-span-5"><h2 className="text-4xl font-bold tracking-tight font-serif">Bring Finverze to Your Campus</h2><p className="mt-4 text-white/75">Connect with us to explore workshops and financial discipline programs designed for your students. For queries: founder@finverze.com.</p><ul className="mt-6 space-y-3 text-white/85">{['Structured delivery','Student-focused implementation','Easy onboarding process'].map((p)=><li key={p} className="inline-flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-blue-300" />{p}</li>)}</ul></div>
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-[100px] text-center lg:px-20"><h2 className="text-4xl font-bold tracking-tight font-serif">Start Building Financially Disciplined Students Today.</h2><Link href="#contact" className="mt-8 inline-flex rounded-[10px] bg-[#2563EB] px-8 py-3 font-medium">Schedule a Discussion</Link></section>
