...
import { ArrowRight, BookOpen, Building2, CheckCircle2, Compass, Handshake, Mail, MapPinned, Target, Users } from "lucide-react"
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#071120] text-white">
      ...
      <section id="about" className="mx-auto max-w-[1500px] px-6 pb-[90px] lg:px-20">
      ...
      <section id="programs" className="mx-auto max-w-[1500px] px-6 pb-[90px] lg:px-20">
      ...
      <section id="vision" className="mx-auto max-w-[1300px] px-6 pb-[90px] lg:px-20">
      ...
      <footer className="border-t border-white/10 py-10"><div className="mx-auto flex max-w-[1500px] flex-col items-center justify-between gap-4 px-6 text-sm text-white/70 md:flex-row lg:px-20"><p className="tracking-[0.14em]">FINVERZE</p><div className="flex gap-4"><a href="#about">About</a><a href="#programs">Programs</a><a href="#contact">Contact</a></div><p className="inline-flex items-center gap-2"><CheckCircle2 className="h-4 w-4" /> founder@finverze.com</p></div></footer>
    </main>
  )
}
