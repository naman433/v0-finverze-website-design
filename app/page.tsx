...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#071120] text-white text-center">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#071120]/60 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-5 lg:px-20">
          ...
          <div className="hidden items-center gap-6 text-sm text-white/80 md:flex">
            ...
            <Link href="#contact" className="rounded-[10px] bg-[#2563EB] px-5 py-3 font-medium">Book a Session</Link>
          </div>
        </nav>
      </header>

      <section className="mx-auto max-w-[1200px] px-6 py-[100px] lg:px-20">
        <h1 className="mx-auto max-w-5xl text-5xl font-bold leading-[1.08] md:text-6xl font-serif">Building Strong Financial Habits for the Next Generation.</h1>
        <p className="mx-auto mt-6 max-w-3xl text-lg text-white/75">Finverze helps colleges equip students with practical financial habits, money discipline, and real-world financial awareness through structured workshops and guided programs.</p>
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link href="#contact" className="rounded-[10px] bg-[#2563EB] px-6 py-3 font-medium">Book a Session</Link>
          <Link href="#programs" className="rounded-[10px] border border-white/20 bg-white/5 px-6 py-3">Explore Programs</Link>
        </div>
        <ul className="mt-7 inline-grid gap-2 text-white/85 text-left">
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-[100px] lg:px-20"><div className="grid gap-4 md:grid-cols-3">{[[BookOpen,'Practical Habit Building'],[Target,'Structured Student Programs'],[Compass,'Real-World Financial Discipline']].map(([I,t])=><div key={t as string} className="rounded-2xl border border-white/10 bg-white/8 p-6 backdrop-blur"><I className="mx-auto h-5 w-5 text-[#8fb6ff]" /><p className="mt-3 font-medium">{t}</p></div>)}</div></section>

      <section id="about" className="mx-auto max-w-[1000px] px-6 pb-[100px] lg:px-20">
        <h2 className="text-4xl font-bold tracking-tight font-serif">Why Finverze Exists</h2>
      ...
      <section id="programs" className="mx-auto max-w-[1200px] px-6 pb-[100px] lg:px-20">
        <h2 className="text-4xl font-bold">Programs Designed to Build Financial Discipline</h2>
        <div className="mt-10 grid gap-5 lg:grid-cols-3 text-left">
      ...
      <section id="vision" className="mx-auto max-w-[1000px] px-6 pb-[100px] lg:px-20">
        <h2 className="text-4xl font-bold tracking-tight font-serif">The Vision Behind Finverze</h2>
