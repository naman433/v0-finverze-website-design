    ...
    <main className="min-h-screen bg-[#071120] text-white">
      ...
      <section className="mx-auto max-w-[1500px] px-6 py-[100px] lg:px-20">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 max-w-2xl text-xl text-white/80">Finverze helps colleges equip students with practical financial habits, money discipline, and real-world financial awareness through structured workshops and guided programs.</p>
      ...
      <section id="about" className="mx-auto grid max-w-[1500px] grid-cols-1 gap-10 px-6 pb-[100px] lg:grid-cols-12 lg:px-20">
        <div className="lg:col-span-8">
          ...
          <p className="mt-4 text-white/80">Most understand theory, but struggle with spending, saving, and real-life decisions.</p>
          <p className="mt-4 text-white/80">Finverze bridges this gap through practical habits that stay beyond college.</p>
        </div>
      </section>
      ...
      <section id="vision" className="mx-auto max-w-[1300px] px-6 pb-[100px] lg:px-20">
        ...
        <p className="mt-4 text-white/80">Students are taught how to build careers — but rarely how to build financial discipline, responsible money habits, or long-term financial awareness.</p>
        <p className="mt-4 text-white/80">Our vision is to build a generation with strong financial discipline from an early stage.</p>
        <p className="mt-4 text-white/80">These programs are the first step toward long-term financial behavior change.</p>
      </section>

      <section className="mx-auto max-w-[1500px] px-6 pb-[100px] lg:px-20"><h2 className="text-5xl font-semibold">Long-Term Vision</h2><div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">{['Building financially disciplined campuses','Creating habit-driven financial systems','Expanding student financial awareness nationwide','Developing a long-term financial growth ecosystem'].map((t)=><div key={t} className="rounded-2xl border border-white/10 bg-white/8 p-5 transition hover:border-[#2563EB]/60">{t}</div>)}</div></section>
      ...
      <section className="mx-auto max-w-[1500px] px-6 pb-[100px] lg:px-20"><h2 className="text-5xl font-semibold tracking-tight">Start Building Financially Disciplined Students Today.</h2><Link href="#contact" className="mt-8 inline-flex rounded-[10px] bg-[#2563EB] px-8 py-3 font-medium">Schedule a Discussion</Link></section>
