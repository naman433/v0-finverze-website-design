...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#071120] text-white text-center">
      ...
      <section className="mx-auto max-w-[1500px] px-6 py-[100px] lg:px-20">
      ...
      <section className="mx-auto max-w-[1500px] px-6 pb-[100px] lg:px-20"><div className="grid gap-4 md:grid-cols-3">{[[BookOpen,'Practical Habit Building'],[Target,'Structured Student Programs'],[Compass,'Real-World Financial Discipline']].map(([I,t])=><div key={t as string} className="rounded-2xl border border-white/10 bg-white/8 p-6 backdrop-blur"><I className="mx-auto h-5 w-5 text-[#8fb6ff]" /><p className="mt-3 font-medium">{t}</p></div>)}</div></section>

      <section id="about" className="mx-auto max-w-[1300px] px-6 pb-[100px] lg:px-20">
      ...
      <section className="mx-auto max-w-[1500px] px-6 pb-[100px] lg:px-20"><h2 className="text-4xl font-bold tracking-tight font-serif">Start Building Financially Disciplined Students Today.</h2><Link href="#contact" className="mt-8 inline-flex rounded-[10px] bg-[#2563EB] px-8 py-3 font-medium">Schedule a Discussion</Link></section>
